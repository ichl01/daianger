...
function homework() {
    ...
    for (var i = 0; i < obj.length; i++) {
        ...
        //要素を挿入
        let content = '<div class="homework"><input type="hidden" value=' + obj[i].id + '><table><tr><td>行事名:</td><td>' + obj[i].subject + '</td></tr><tr><td>範囲:</td><td>' + obj[i].content + '</td></tr></table></div>'
